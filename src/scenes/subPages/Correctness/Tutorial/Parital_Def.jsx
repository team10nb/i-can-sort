    ...
    return (
        <Card style={styles.root}>
            <CardContent style={styles.card1}>
                ...
                <div style={styles.div}>
                    For every legal input, if the algorithm terminates, then it
                    produces an expected output. On the other hand, if the
                    algorthm failed to terminate, it is still partially correct.
                </div>
            </CardContent>
