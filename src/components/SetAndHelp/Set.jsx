/*
  ...
  clsx library for configure drawer.
*/
                ...
                <AccordionDetails>
                    <Paper elevation={0}>
                        <Typography
                            ...
                            gutterBottom
                        >
                            We are university students from UNNC, dedicated to
                            help users learn sorting algorithms and correctness.
                        </Typography>
                    </Paper>
                </AccordionDetails>
            </Accordion>
            ...
            <Accordion>
                ...
                <AccordionDetails>
                    <Paper elevation={0}>
                        ...
                        <Button onClick={handleLink} className={classes.link}>
                            GitHub Address:&nbsp;&nbsp;I - can - sort
                        </Button>
                    </Paper>
                </AccordionDetails>
            </Accordion>
                        ...
                        <Collapse in={open}>
                            <Alert severity="warning">
                                <div className={classes.warning}>
                                    ...
                                    All study progress will be reset.
                                </div>
                                <Link
